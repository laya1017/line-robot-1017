...
def newWordsSearch(msg):
    ...
    if "危險駕車" in msg or "危駕" in msg or "危險駕駛" in msg :
        ...
        pass
    word_list = ["駕駛人","救護車","救險車","行人","慢車道","行動載具","人行","超車","吊銷","註銷","業經","公路","改善","危險物品","有危險","高速公路","傳單"]
    symWords = {
        '機車':["機車",'機','車'],
        '無照':list("駕駛執照"),
        '高、快速公路':["高速公路","快速公路"],
        ...
        '慢車':['電動輔助自行車','慢車','微型','電動','二輪','行動載具'],'微型電動二輪車':['微型','電動','二輪','慢車'],'電動輔助自行車':['電動輔助自行車','慢車'],
        '個人行動載具':['個人行動載具','慢車'],
        '次':['累','次'],
        '轉彎':list('左右轉彎'),
        '交通事故':list("交通事故肇事"),
