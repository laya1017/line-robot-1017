...
def handle_message(event):
    ...
    if msg == "Machine":
        reply = TextSendMessage(text="道安規則§83-2：\n動力機械行駛於道路時，其駕駛人必須領有小型車以上之駕駛執照。但自中華民國九十六年一月一日起，總重量逾3.5公噸之動力機械，其駕駛人應領有大貨車以上之駕駛執照；自中華民國101年1月1日起，重型及大型重型之動力機械，其駕駛人應領有聯結車駕駛執照。")
    elif msg == "HMOT":
        ...
        if  msg == "[關鍵字搜尋模式]":
            ...
            if msg == "處罰機關如何判斷？":
                ...
                reply = TextSendMessage(
                    text="依據道路交通管理處罰條例§85-4，未滿14歲之人違反本條例之規定，處罰其\"法定代理人\"或\"監護人\"。\n而依違反道路交通管理事件統一裁罰基準及處理細則11條1項3款，應於通知單上另行查填其法定代理人或監護人之姓名、身分證統一編號及地址，並\"送達\"其\"法定代理人\"或\"監護人\"。",
                    quick_reply=QuickReply(
                        items=[
