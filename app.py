...
def handle_message(event):
    ...
    if uid not in r.get("ID_list").decode('utf-8').split(',') :
        ...
        reply = FlexSendMessage(
            ...
            contents=BubbleContainer(
                ...
                body=BoxComponent(
                    layout='vertical',
                    contents=[
                    TextComponent(text="道安規則§83-2：",align="center",size="xl",weight="bold",color="#eb4034"),
                    TextComponent(text='動力機械行駛於道路時，其駕駛人必須領有小型車以上之駕駛執照。但自中華民國96年1月1日起，總重量逾3.5公噸之動力機械，其駕駛人應領有大貨車以上之駕駛執照；自中華民國101年1月1日起，重型及大型重型之動力機械，其駕駛人應領有聯結車駕駛執照。',size="lg",wrap=True),
                    ]
                    )
                )
            )
        ...
        reply = FlexSendMessage(
            ...
            contents=BubbleContainer(
                ...
                body=BoxComponent(
                    layout='vertical',
                    contents=[
                    TextComponent(text="道交條例§92II",align="center",size="xl",weight="bold",color="#eb4034"),
                    TextComponent(text='汽缸排氣量550立方公分以上大型重型機車，得依交通部公告規定之路段及時段行駛高速公路，其駕駛人應有得駕駛汽缸排氣量550立方公分以上大型重型機車駕駛執照1年以上及小型車以上之駕駛執照。',size="lg",wrap=True),
                    ]
                    )
                )
            )
        ...
        reply = FlexSendMessage(
            ...
            contents=BubbleContainer(
                ...
                body=BoxComponent(
                    layout='vertical',
                    contents=[
                    TextComponent(text="道安規則§102",align="center",size="xl",weight="bold",color="#eb4034"),
                    TextComponent(text='1項4款：',size="lg",weight="bold"),
                    TextComponent(text='右轉彎時，應距交岔路口三十公尺前顯示方向燈或手勢，換入外側車道、右轉車道或慢車道，駛至路口後再行右轉。但由慢車道右轉彎時應於距交岔路口三十至六十公尺處，換入慢車道。',size="lg",wrap=True),
                    TextComponent(text='1項5款：',size="lg",weight="bold"),
        ...
        reply = FlexSendMessage(
            ...
            contents=BubbleContainer(
                ...
                body=BoxComponent(
                    layout='vertical',
                    contents=[
                    TextComponent(text="道安規則§111",align="center",size="xl",weight="bold",color="#eb4034"),
                    TextComponent(text='2項：',size="lg",weight="bold"),
                    TextComponent(text='汽車臨時停車時，應依車輛順行方向緊靠道路邊緣，其前後輪胎外側距離緣石或路面邊緣不得逾60公分。但大型車不得逾1公尺。',size="lg",wrap=True),
                    TextComponent(text='3項：',size="lg",weight="bold"),
                    TextComponent(text='大型重型機車及機車臨時停車時，應依車輛順行方向緊靠道路邊緣停放，其前輪或後輪外側距離緣石或路面邊緣不得逾40公分。',size="lg",wrap=True)
                    ]
                    )
                )
            )
        ...
        reply = FlexSendMessage(
            ...
            contents=BubbleContainer(
                ...
                body=BoxComponent(
                    layout='vertical',
                    contents=[
                    TextComponent(text="道安規則§112",align="center",size="xl",weight="bold",color="#eb4034"),
                    TextComponent(text='2項：',size="lg",weight="bold"),
                    TextComponent(text='汽車停車時應依車輛順行方向緊靠道路邊緣，其前後輪胎外側距離緣石或路面邊緣不得逾40公分。',size="lg",wrap=True),
                    TextComponent(text='3項：',size="lg",weight="bold"),
                    TextComponent(text='大型重型機車及機車停車時，應依車輛順行方向緊靠道路邊緣平行、垂直或斜向停放，其前輪或後輪外側距離緣石或路面邊緣不得逾30公分。但公路主管機關、市區道路主管機關或警察機關另有特別規定時，應依其規定。',size="lg",wrap=True)
                    ]
                    )
                )
            )
        ...
        reply = FlexSendMessage(
            alt_text='EnforcementRules_weight',
            contents=BubbleContainer(
                size="giga",
                body=BoxComponent(
                    layout='vertical',
                    ...
                    TextComponent(text='2項：',size="lg",weight="bold"),
                    TextComponent(text='貨車超載應責令當場卸貨分裝，如無法當場卸貨分裝者，其超載重量未逾核定總重量20%者，責令其於2小時內改正之，逾2小時不改正者，得連續舉發；其超載重量逾核定總重量20%者，當場禁止其通行。',size="lg",wrap=True)
                    ]
                    )
                )
            )
        ...
        reply = FlexSendMessage(
            ...
            contents=BubbleContainer(
                ...
                body=BoxComponent(
                    ...
                    TextComponent(text="道交條例§85-1",align="center",size="xl",weight="bold",color="#eb4034"),
                    TextComponent(text='1項：',size="lg",weight="bold"),
                    TextComponent(text='汽車駕駛人、汽車所有人、汽車買賣業或汽車修理業違反第56條第1項或第57條規定，經舉發後，不遵守交通勤務警察或依法令執行交通稽查任務人員責令改正者，得連續舉發之。',size="lg",wrap=True)
                    ]
                    )
                )
            )
        ...
        reply = FlexSendMessage(
            alt_text='EnforcementRules_Stopping',
            contents=BubbleContainer(
                size="giga",
                body=BoxComponent(
                    layout='vertical',
                    ...
                    TextComponent(text="處理細則§12",align="center",size="xl",weight="bold",color="#eb4034"),
                    TextComponent(text='1項5款：',size="lg",weight="bold"),
                    TextComponent(text='駕駛汽車因上、下客、貨，致有本條例第五十五條之情形，惟尚無妨礙其他人、車通行。',size="lg",wrap=True)
                    ]
                    )
                )
            )
        ...
        reply = FlexSendMessage(
            alt_text='EnforcementRules_Parking',
            contents=BubbleContainer(
                size="giga",
                body=BoxComponent(
                    layout='vertical',
                    contents=[
                    TextComponent(text="處理細則§12",align="center",size="xl",weight="bold",color="#eb4034"),
                    TextComponent(text='1項6款：',size="lg",weight="bold"),
                    TextComponent(text='深夜時段（零至六時）停車，有本條例第五十六條第一項之情形。但於身心障礙專用停車位違規停車或停車顯有妨礙消防安全之虞，或妨礙其他人車通行經人檢舉者，不在此限。',size="lg",wrap=True)
                    ]
                    )
                )
            )
        ...
        reply = FlexSendMessage(
            ...
            contents=BubbleContainer(
                ...
                body=BoxComponent(
                    ...
                    contents=[
                    TextComponent(text="道安規則§112：",align="center",size="xl",weight="bold",color="#eb4034"),
                    TextComponent(text='4項：',size="lg",weight="bold"),
                    TextComponent(text='汽車發生故障不能行駛，應即設法移置於無礙交通之處，在未移置前或移置後均應依下列規定豎立車輛故障標誌，車輛駛離現場時，應即拆除：\n一、在行車時速四十公里以下之路段，應豎立於車身後方五公尺至三十公尺之路面上，車前適當位置得視需要設置。\n二、在行車時速逾四十公里之路段，應豎立於車身後方三十公尺至一百公尺之路面上，車前適當位置得視需要設置。\n三、交通擁擠之路段，應懸掛於車身之後部，車前適當位置得視需要設置。',size="lg",wrap=True),
                    ]
                    )
                )
            )
        ...
        reply = FlexSendMessage(
            alt_text='道路交通事故處理辦法§4',
            contents=BubbleContainer(
                size="giga",
                body=BoxComponent(
                    layout='vertical',
                    contents=[
                    TextComponent(text="道路交通事故處理辦法§4",align="center",size="xl",weight="bold",color="#eb4034"),
                    TextComponent(text='1項：',size="lg",weight="bold"),
                    TextComponent(text='1.高速公路：於事故地點後方100公尺處。\n2.快速道路或最高速限超過60公里之路段：於事故地點後方80公尺處。\n3.最高速限超過50公里至60公里之路段：於事故地點後方50公尺處。\n4.最高速限50公里以下之路段：於事故地點後方30公尺處。\n5.交通壅塞或行車時速低於10公里以下之路段：於事故地點後方5公尺處。',size="lg",wrap=True),
                    TextComponent(text='2項：',size="lg",weight="bold"),
                    TextComponent(text='前項各款情形，遇雨霧致視線不清時，適當距離應酌予增加；其有雙向或多向車流通過，應另於前方或周邊適當處所為必要之放置。',size="lg",wrap=True)
                    ]
                    )
                )
            )
        ...
        reply = FlexSendMessage(
            ...
            contents=BubbleContainer(
                ...
                body=BoxComponent(
                    layout='vertical',
                    contents=[
                    TextComponent(text="道交條例§85-2",align="center",size="xl",weight="bold",color="#eb4034"),
                    TextComponent(text='1項：',size="lg",weight="bold"),
                    TextComponent(text='車輛所有人或駕駛人依本條例規定應予禁止通行、禁止其行駛、禁止其駕駛者，交通勤務警察或依法令執行交通稽查任務人員應當場執行之，必要時，得逕行移置保管其車輛。',size="lg",wrap=True),
                    TextComponent(text="處理細則§11",align="center",size="xl",weight="bold",color="#eb4034"),
                    TextComponent(text='2項：',size="lg",weight="bold"),
                    TextComponent(text='對於依規定須責令改正、禁止通行、禁止其行駛、禁止其駕駛者、補換牌照、駕照等事項，應當場告知該駕駛人或同車之汽車所有人，並於通知單記明其事項或事件情節及處理意見，供裁決參考。',size="lg",wrap=True)
                    ]
                    )
                )
            )
        ...
        if  msg == "[關鍵字搜尋模式]":
            ...
            if msg == "Violation":
                ...
                reply = TextSendMessage(
                    text="依據法務部法檢字第1000014063號函：\n要旨：\n參照刑法第 185條之 3規定，「腳踏自行車」「電動輔助自行車」「微型電動二輪車」是否符合該條之「動力交通工具」，端視其推動是否以電力或引擎動力等作用而斷\n主旨：就所詢刑法第 185條之 3「動力交通工具」之適用範圍乙案，復如說明，請查照。\n說明：\n一、復貴署100年5月23日警署交字第1000117598號函。\n二、刑法第185條之3之「動力交通工具」，係指交通工具之推動是以電力或引擎動力等作用者，至其為蒸汽機、內燃機，抑或係柴油、汽油、天然氣、核子、電動，均非所問。又所謂交通工具不限於陸路交通工具，尚包含水上、海上、空中或鐵道上之交通工具。所詢之「腳踏自行車」「電動輔助自行車」「微型電動二輪車」是否符合刑法第185條之3之「動力交通工具」，端視其推動是否以電力或引擎動力等作用而斷。惟如涉及具體個案，應由承辦之檢察官或法官依職權判斷。\n正本：內政部警政署\n副本：本部檢察司、本部檢察司一股",
                    quick_reply=QuickReply(
                        items=[
                        QuickReplyButton(action=MessageAction(label="上一步", text="dwimode_SMV_Ex")),
                        QuickReplyButton(action=MessageAction(label="離開", text="Exit"))
